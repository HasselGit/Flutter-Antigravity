...
import 'compras_home_model.dart';
export 'compras_home_model.dart';

/// Home Compras
class ComprasHomeWidget extends StatefulWidget {
  const ComprasHomeWidget({super.key});

  static String routeName = 'ComprasHome';
  static String routePath = '/comprasHome';
...
class _ComprasHomeWidgetState extends State<ComprasHomeWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComprasHomeModel());
  }
