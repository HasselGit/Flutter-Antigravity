              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Text(
                      'TIEMPO REAL',
                      style: TextStyle(fontFamily: 'Work Sans', fontWeight: FontWeight.w700, fontSize: 8, color: kOnSurfaceVariant, letterSpacing: 0.5),
                    ),
                  ),
                ],
              ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            ...
                            style: TextStyle(fontFamily: 'Inter', fontSize: 14, color: kOnSurfaceVariant),
                          ),
                        ],
                      ),
                    );
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        onTap: () {
                          if (item['id'] != null) {
                            context.push('/pesajesItem?paradaItemId=${item['id']}');
                          }
                        },
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              const Icon(Icons.chevron_right_rounded, color: kOutlineVariant),
                            ],
                          ),
                        ),
                      );
                ...
                children: [
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () {
                        context.push('/remito?paradaId=${widget.paradaId}');
                      },
